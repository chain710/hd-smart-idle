...
var runCmd = &cobra.Command{
    ...
    Run: func(cmd *cobra.Command, args []string) {
        // logging setup
        if useStdLog {
            // If user asked for std log, wrap logrus to stdout at Info level
...
func init() {
    ...
    runCmd.Flags().BoolVar(&useStdLog, "use-stdlog", false, "use Go std log formatting (otherwise logrus with timestamps)")
}
